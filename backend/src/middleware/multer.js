...
const createUploadDirs = () => {
  ...
  const dirs = [
    ...
    "uploads/delivery_agents/photos",
...
const getUploadSubDir = (fieldname) => {
  switch (fieldname) {
    ...
    case "farmerDocuments":
      return "farmers/documents";
    case "deliveryAgentDocuments":
      return "delivery_agents/documents";
    case "vehiclePhotos":
      return "delivery_agents/photos";
    default:
      return "misc";
  }
};
...
const fileFilter = (req, file, cb) => {
  ...
  if (["documents", "deliveryAgentDocuments", "farmerDocuments"].includes(file.fieldname)) {
